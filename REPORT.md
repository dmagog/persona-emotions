...
направлений эмоций проекция на SAE не расщепляет (Jaccard 0.91), а контраст активаций
...
**Находка:** попарные косинусы между векторами эмоций **0.58–0.86** (все
...
disgust +8 (на эмоциональных промптах те же векторы давали +28..+57). То есть стиринг **усиливает
...
3. Векторы эмоций сильно скоррелированы (косинусы 0.45–0.86, и на Qwen, и на Gemma).
   ...
   инструмент.
4. **Устойчивый методологический результат:** для направлений эмоций проекция на SAE не
...
- **Данная работа**: блок измерения (энкодер + AUC, pairwise-судья + кросс-проверка),
  извлечение векторов эмоций и стиринг, матрицы специфичности, расщепление
  (центрирование E0; SAE-проекция E1; контрастные активации SAE E1c — минимальный
  вектор эмоции), стиринг через SAE-фичи и судейская оценка специфичности; усиление
  ...
  вторым судьёй (согласие), базовый эмоциональный приор, coeff-matched сравнение raw vs SAE,
