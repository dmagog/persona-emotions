...
При использовании конвейера или опубликованных прогонов ссылка на репозиторий
оформляется согласно [CITATION.cff](CITATION.cff). Репозиторий распространяется
под лицензией MIT (см. [LICENSE](LICENSE); лицензия унаследована от
upstream-репозитория).
