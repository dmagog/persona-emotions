...
Замечание про guilt. Исходный датасет guilt (9 промптов) был расширен до 25
промптов в течение работы; новые pos/neg-ответы сгенерированы (125 пар, 115
прошли фильтр судьи). На момент написания основные результаты §7–§9 для guilt
получены на старом наборе (n=42 пары); пересборка guilt-вектора и пересчёт
guilt-строки матрицы — в следующей итерации. Это отдельно отмечено в «Угрозах».
...
диагонали значимо положительны (целевая доминирует у 6/7); рядом с диагональю —
