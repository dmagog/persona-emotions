...
Llama-моделям +1.2 балла, gemini к Gemma +4.2. В каждой «семье» по две модели из
одиннадцати, так что это оценка порядка величины, а не тест. Все файлы `judge_wide_<tag>.csv`, `judge_agreement_<tag>.md`,
