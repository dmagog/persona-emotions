...
На исходном пуле промптинг был сильнее по диагонали у 5/7 (joy +57, guilt +58,
anger/disgust выше), специфичнее (sadness-протечка +18 [9,27] против +28 [20,37])
и давал target=argmax 7/7. После пересборки пула со свежими guilt-промптами
стиринг догнал/обошёл инструкцию по joy (+56) и shame (+59), однако специфичность
осталась за промптингом (sadness-протечка +18 vs +25 у стиринга, argmax 7/7 vs
4/7). Сравнение прямое только частично: промптинг-baseline ещё не пересудили на
новом пуле n=56 — это следующая итерация.
